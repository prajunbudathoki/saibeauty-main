...
export function AppointmentDetail({ appointment, services }) {
  ...
  const handleStaffSelect = async () => {
    ...
    try {
      await assignStaffToAppointment(appointment.id);
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <AppointmentStatusBadge status={status} className={""} />
                <Select
                  value={status}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <div className="font-medium">
                        {service.location_service?.service?.name}
                      </div>
              ...
              {appointment.review && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="mt-1 bg-muted/30 p-3 rounded-md">
                      {appointment.review}
                    </div>
                  </div>
                </div>
